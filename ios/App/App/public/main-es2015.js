...
const routes = [
    ...
    {
        path: 'searchpage',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_searchpage_searchpage_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./searchpage/searchpage.module */ 31895)).then(m => m.SearchpagePageModule)
    },
    {
        path: 'notification',
